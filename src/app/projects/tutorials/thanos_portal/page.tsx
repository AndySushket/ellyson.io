...
export default class thanosPortal extends TemplateFor3D {
  ...
  initLight() {
    ...
    this.scene?.add(this.directionalLight, this.clonedDirectionalLight,)
  }

  initPointLight() {
    this.portalLight = new THREE.PointLight(0x062d89, 30, 800, .1);
