...
export default class Shader1 extends TemplateFor3D {
	...
	initProject() {
		...
		const ambientOcclusionTexture = textureLoader.load(AmbientOcclusionMap.src);
		const heightTexture = textureLoader.load(heightMap.src);
		const metallicTexture = textureLoader.load(metallicMap.src);
		const normalTexture = textureLoader.load(normalMap.src);
		const opacityTexture = textureLoader.load(opacityMap.src);
		const roughnessTexture = textureLoader.load(roughnessMap.src);
		const testTexture = textureLoader.load(testMap.src);
