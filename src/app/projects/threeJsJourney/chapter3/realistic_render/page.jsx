...
// Получаем путь директории
		...
		const floorColorTexture = textureLoader.load(texture.src)
		const floorNormalTexture = textureLoader.load(texture5.src)
		const floorAORoughnessMetalnessTexture = textureLoader.load(texture6.src)
		...
		const wallColorTexture = textureLoader.load(texture2.src)
		const wallNormalTexture = textureLoader.load(texture3.src)
		const wallAORoughnessMetalnessTexture = textureLoader.load(texture4.src)
