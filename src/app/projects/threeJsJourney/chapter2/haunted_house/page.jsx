...
//floor
import floorAlpha from "./resources/floor/alpha.webp";
import floorColor from "./resources/floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_diff_1k.jpg";
import floorNormal from "./resources/floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_nor_gl_1k.jpg";
import floorARM from "./resources/floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_arm_1k.jpg";
import floorDISP from "./resources/floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_disp_1k.jpg";

//walls
import wallsColor from "./resources/wall/castle_brick_broken_06_1k/castle_brick_broken_06_diff_1k.jpg";
import wallsNormal from "./resources/wall/castle_brick_broken_06_1k/castle_brick_broken_06_nor_gl_1k.jpg";
import wallsARM from "./resources/wall/castle_brick_broken_06_1k/castle_brick_broken_06_arm_1k.jpg";

//roof
import roofColor from "./resources/roof/roof_slates_02_1k/roof_slates_02_diff_1k.jpg";
import roofNormal from "./resources/roof/roof_slates_02_1k/roof_slates_02_nor_gl_1k.jpg";
import roofARM from "./resources/roof/roof_slates_02_1k/roof_slates_02_arm_1k.jpg";

//bush
import bushColor from "./resources/bush/leaves_forest_ground_1k/leaves_forest_ground_diff_1k.jpg";
import bushNormal from "./resources/bush/leaves_forest_ground_1k/leaves_forest_ground_nor_gl_1k.jpg";
import bushARM from "./resources/bush/leaves_forest_ground_1k/leaves_forest_ground_arm_1k.webp";

//graves
import graveColor from "./resources/grave/plastered_stone_wall_1k/plastered_stone_wall_diff_1k.jpg";
import graveNormal from "./resources/grave/plastered_stone_wall_1k/plastered_stone_wall_nor_gl_1k.jpg";
import graveARM from "./resources/grave/plastered_stone_wall_1k/plastered_stone_wall_arm_1k.jpg";

//doors
import doorColor from "./resources/door/color.jpg";
import doorNormal from "./resources/door/normal.jpg";
import doorAlpha from "./resources/door/alpha.jpg";
import doorAO from "./resources/door/ambientOcclusion.jpg";
import doorHeight from "./resources/door/height.jpg";
import doorMetalness from "./resources/door/metalness.jpg";
import doorRoughness from "./resources/door/roughness.jpg";
...
export default class HauntedHouse extends TemplateFor3D {
  ...
  initProject() {
    ...
    const floorColorTexture = textureLoader.load(floorColor.src);
    ...
    const floorDISPTexture = textureLoader.load(floorDISP.src);
    floorDISPTexture.wrapS = THREE.RepeatWrapping;
    floorDISPTexture.wrapT = THREE.RepeatWrapping;
    floorDISPTexture.repeat.set(8, 8);

    const wallsColorTexture = textureLoader.load(wallsColor.src);
    wallsColorTexture.colorSpace = THREE.SRGBColorSpace;
    const wallsNormalTexture = textureLoader.load(wallsNormal.src);
    const wallsARMTexture = textureLoader.load(wallsARM.src);

    const roofColorTexture = textureLoader.load(roofColor.src);
    ...
    const bushColorTexture = textureLoader.load(bushColor.src);
    ...
    const graveColorTexture = textureLoader.load(graveColor.src);
    ...
    const doorARMTexture = textureLoader.load(doorAO.src);
