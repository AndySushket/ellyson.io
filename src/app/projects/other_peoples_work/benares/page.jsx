...
import posx from './textures/cube/posx.jpg';
import negx from './textures/cube/negx.jpg';
import posy from './textures/cube/posy.jpg';
import negy from './textures/cube/negy.jpg';
import posz from './textures/cube/posz.jpg';
import negz from './textures/cube/negz.jpg';

import mp3 from './sound/holbaumannbenares.mp3';

const urls = [posx.src, negx.src, posy.src, negy.src, posz.src, negz.src];

import aum from './textures/aum.png';
import benares from './textures/benares.png';
...
export default class Benares extends TemplateFor3D {
  ...
  componentDidMount() {
    ...
    const texAum = textureLoader.load(aum.src);
    const texBenares = textureLoader.load(benares.src);
    console.log("start");
    // #endregion
