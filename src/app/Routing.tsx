    ...
    <Routes>
        ...
        <Route path="MusicVisualization">
          ...
          <Route
            ...
            element={<MusicVisualization.MusicEqualizer />}
          />
        ...
        <Route path="Akella">
          ...
          dw
          <Route
            path="TriangleWallpaper"
            element={<Akella.TriangleWallpaper />}
          />
        ...
        <Route path="MainFunc">
          ...
          <Route
            path="PositionRotationScale"
            element={<MainFunc.PositionRotationScale />}
          />
