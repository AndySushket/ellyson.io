/*! by @vlucendo -- http://vlucendo.com */ ! function(c) {
	...
	let t = window.webpackJsonp = window.webpackJsonp || [];
		const i = t.push.bind(t);
	t.push = e, t = t.slice();
	...
	const h = function e(t, n, i) {
			...
			}(this, e), this.camera = t, this.mainUniforms = n, this.scene = new s.o, this.cubeTexture = i === 0 ? this.mainUniforms.texture1 : this.mainUniforms.texture2, this.scene.background = this.cubeTexture, this.pass = new o.a(this.scene, this.camera, !1, !1, !1), this.pass.clear = !1, this.pass.needsSwap = !1, this.pass.setSize = function(e, t) {}, this.pass.renderToScreen = !1
		};
		const f = n(4);
		const p = n(12);
		const v = n.n(p);
	...
	const k = function() {
			...
			return e = r, (t = [{
				...
				key: "createPortal",
				value() {
					const e = new s.e(this.mainUniforms.portalRadius, 70);
	...
	document;
	const D = "ontouchstart" in document;
		const q = (document, document, function(e) {
			function o(e, t, n) {
				let i; let r; let a;
				return function(e, t) {
					if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
				...
				})) || j(a) !== "object" && typeof a !== "function" ? A(r) : a).mainUniforms = {
					...
					bloomStr: .76,
					threshold: .8
				}, i._isFirefox = i.store.client.browser === "firefox", i._isEdge = i.store.client.browser === "edge" || i.store.client.browser === "explorer", i._mouseMultiplier = 1, i._touchMultiplier = 1, i._firefoxMultiplier = 33, i._edgeMultiplier = .4, i._generalMultiplier = 8e-5, i._generalTouchMultiplier = 5e-4, i.scrollAmount = 0, i.progress = {
					live: 0,
					total: 0
				}, i._touchStartValues = {
					x: 0,
			...
			return function(e, t) {
				...
				value(e) {
					let t = e.deltaY;
					this._isFirefox && e.deltaMode === 1 && (t *= this._firefoxMultiplier), this._isEdge && Math.abs(t) > 100 && (t *= this._edgeMultiplier), t *= this._mouseMultiplier, t *= this._generalMultiplier, this.scrollAmount += t, e.preventDefault()
				}
			}, {
				key: "_onTouchStart",
				value(e) {
				...
				value(e) {
					const t = e.targetTouches ? e.targetTouches[0] : e;
						let n = (this._touchStartValues.y - t.clientY) * this._touchMultiplier;
				...
				value() {
					...
					this.renderer = new s.u({
						...
						antialias: !1,
						transparent: !0
					}), this.renderer.setClearColor("#ffffff"), this.renderer.autoClear = !1, this.camera = new s.k(45, this.store.client.sizes.width / this.store.client.sizes.height, 1e-4, 100), this.camera.target = new s.s(0, -.5, 0), this.camera.position.set(0, 0, 10), this.camera.lookAt(this.camera.target), this.baseTarget = new s.s(0, -.5, 0), this.createCameraSpline(), this.effectComposerScene1 = new m.a(this.renderer), this.passScene1 = new h(this.camera, this.mainUniforms, 0), this.effectComposerScene1.addPass(this.passScene1.pass), this.effectComposerScene2 = new m.a(this.renderer), this.passScene2 = new h(this.camera, this.mainUniforms, 1), this.effectComposerScene2.addPass(this.passScene2.pass), this.effectComposerScenePortal = new m.a(this.renderer), this.passPortal = new k(this.camera, this.mainUniforms), this.passPortal.bgMaterial.uniforms.tScene.value = this.effectComposerScene1.readBuffer.texture, this.passPortal.portalMaterial.uniforms.tScene.value = this.effectComposerScene2.readBuffer.texture, this.effectComposerScenePortal.addPass(this.passPortal.pass), this.passBloom = new U(this.mainUniforms.bloomRadius, this.mainUniforms.bloomStr, this.mainUniforms.threshold), this.effectComposerScenePortal.addPass(this.passBloom.pass), this.prevCameraPosition = (new s.s).copy(this.camera.position), this._v0 = new s.r, this._v1 = new s.s, this._v2 = new s.s, this._v3 = new s.s, this.side = 0, Object(c.a)(-1, () => {
						if (t.mousePositionAnimation.pause().reset(), t.mousePositionAnimation._els[0].properties[0].from = t.mousePosition.x, t.mousePositionAnimation._els[0].properties[0].to = t.store.client.mousePosition.x, t.mousePositionAnimation._els[0].properties[1].from = t.mousePosition.y, t.mousePositionAnimation._els[0].properties[1].to = t.store.client.mousePosition.y, t.mousePositionAnimation.play(), t.updateScroll(), t.updateCamera(), (t.side === 0 && t.camera.position.z < 0 && t.prevCameraPosition.z >= 0 || t.side === 1 && t.camera.position.z >= 0 && t.prevCameraPosition.z < 0) && (t._v0.x = t.camera.position.x, t._v0.y = t.camera.position.y, t._v0.length() <= t.mainUniforms.portalRadius)) {
							t.side = Math.abs(t.side - 1);
							const e = t.passScene1.cubeTexture;
				...
				key: "updateScroll",
				value() {
					const e = this.progress.total + this.scrollAmount;
	...
	document.readyState !== "loading" ? (new q).render() : document.addEventListener("DOMContentLoaded", () => {
		(new q).render()
	}, !1)
}]);
